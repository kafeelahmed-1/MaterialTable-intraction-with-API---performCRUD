...
const CustomTable = () => {
  ...
  const handleAddSave = async () => {
    try {
      ...
      setButtonsVisible(false); // Hide buttons after adding
    } catch (error) {
  ...
  const columns = [
    { field: "id", headerName: "ID", headerClassName: "custom-header", width: 90 },
    { field: "name", headerName: "Name", headerClassName: "custom-header", width: 150 },
    { field: "age", headerName: "Age", headerClassName: "custom-header", width: 100 },
    { field: "city", headerName: "City", headerClassName: "custom-header", width: 150 },
    { field: "phone", headerName: "Phone", headerClassName: "custom-header", width: 150 },
    { field: "email", headerName: "Email", headerClassName: "custom-header", width: 200 },
    {
      field: "actions",
      headerName: "Actions",
      flex: 1,
  ...
  return (
    ...
    >
      ...
      >
        {/* Hamburger Button */}
        <IconButton onClick={toggleMenu}   style={{ position: 'absolute', right: '16px', top: '10px', background: 'white', border: '1px solid #ccc', borderRadius: '4px', zIndex: 1 }} >
          <MenuIcon />
        </IconButton>

        {/* Hamburger Menu */}
        {menuOpen && (
          <div className="hamburger-menu" style={{ position: 'absolute', right: '10px', top: '60px', background: 'tranparent', border: '1px solid #ccc', borderRadius: '4px', zIndex: 1 }} >
          <a href="https://github.com/kafeelahmed-1" target="_blank" rel="noopener noreferrer">
  <Button>Profile</Button>
        ...
        <div className="heading-search" style={{ flex: 1 }}>
          <h2 style={{ margin: 0, paddingLeft: "25px" }}>User Details</h2>
          <div style={{ display: "flex", alignItems: "center" }}>
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <IconButton position="start" style={{ margin: 0, paddingRight: "15px" }} >
                    <SearchIcon />
                  </IconButton>
                ),
              }}
